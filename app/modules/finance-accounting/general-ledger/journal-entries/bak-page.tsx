...
const ledgerOptions: Array<{ label: string; value: string }> = [
...
const validateEntryForm = (
    ...
    if (!ledgerValue) {
        errors.ledger = "Ledger is required.";
    } else if (!ledgerOptions.some((option) => option.value === ledgerValue)) {
    ...
    const handleLineChange = <Field extends keyof JournalLineForm>(
        ...
        setFormErrors((current) => {
            ...
            switch (field) {
                ...
                case "debit":
                case "credit":
                    updatedLineErrors[field as keyof JournalLineError] =
                        undefined;
                    break;
                default:
                    break;
                                        ...
                                        <div className="flex items-center gap-3">
                                            <div className="flex items-center gap-2">
                                                <button
                                                    type="submit"
                                                    form={formId}
                                                    className="inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm transition focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 hover:bg-indigo-500"
                                                >
                                                    Save
                                                </button>
                                                <button
                                                    ...
                                                    className="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 transition hover:bg-gray-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                                                >
                                                    Submit
                                                </button>
                                                <button
                                                    ...
                                                    className="inline-flex items-center rounded-md bg-rose-50 px-3 py-2 text-sm font-semibold text-rose-600 shadow-sm ring-1 ring-inset ring-rose-200 transition hover:bg-rose-100 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-500"
                                                >
                                                    Post
                                                </button>
                                            </div>
